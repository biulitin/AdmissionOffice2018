    ...
    void clickAdd(ActionEvent event) throws SQLException {
        ...
        info[4] = birthday.getValue().toString();
                ...
                switch(is_enrolled.getSelectionModel().getSelectedItem()){
                    case "Зачислен на 0 этапе": info[11] = "0";
                    break;
                    case "Зачислен в 1 волну":info[11] = "1";
                        break;
                    case "Зачислен во 2 волну": info[11] = "2";
                    break;
                    case "Зачислен в волну коммерции": info[11] = "3";
                    break;
                    case "Не зачислен": info[11] = "-1";
                    break;
                    case "Нет информации": info[11] = "";
                    break;
